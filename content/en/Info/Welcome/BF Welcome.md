...
`The US Government has filed a patent application for the "Bugs Framework (BF) System and Methods". For collaboration, research or implementation options, contact the BF PI at bf@nist.gov and/or the NIST Technology Partnerships Office (TPO) at: [tpo@nist.gov](tpo@nist.gov).`
_____________________________________
