...
# <l style="color: #6366f1">Other Classifications</l>

##### <l style="color: #6366f1">[Common Weakness Enumeration (CWE)](https://cwe.mitre.org/)</l>
...
##### <l style="color: #6366f1">Software Fault Patterns (SFP)</l>
...
##### <l style="color: #6366f1">[NSA Center for Assured Software (CAS)](https://samate.nist.gov/docs/CAS_2011_SA_Tool_Method.pdf)</l>

The NSA Center for Assured Software (CAS) defines a set of Weakness Classes in its "Static Analysis Tool Study - Methodology".

##### <l style="color: #6366f1">Software State-of-the-Art Resources (SOAR)</l>
...
##### <l style="color: #6366f1">[SEI CERT C Coding Standard](https://www.sei.cmu.edu/downloads/sei-cert-c-coding-standard-2016-v01.pdf)</l>
...
##### <l style="color: #6366f1">[Common Vulnerabilities and Exposures (CVE)](https://cve.mitre.org/)</l>
...
##### <l style="color: #6366f1">[Open Web Application Security Project (OWASP)](https://owasp.org/)</l>

The Open Web Application Security Project (OWASP) defines 20 categories of vulnerabilities.

##### <l style="color: #6366f1">[Common Attack Pattern Enumeration and Classification (CAPEC)](https://capec.mitre.org/)</l>
...
##### <l style="color: #6366f1">[ISO/IEC JTC1/SC22/WG23 Technical Report](http://www.open-std.org/JTC1/SC22/WG23/docs/documents)</l>
