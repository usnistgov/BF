...
- UI 
  ...
  [https://10.210.91.216:7654/BFVUL.xml](https://10.210.91.216:7654/BFVUL.xml)<br/>
  [https://10.210.91.216:7654/BFVUL.json](https://10.210.91.216:7654/BFVUL.json)
...
- API  <br/>
  ...
  C# <br/>
      ...
      //result in XML
      var responseXML = await client.GetAsync("BFVUL.xml/api");
      responseXML.EnsureSuccessStatusCode();        
      var resultXML = await responseXML.Content.ReadAsStringAsync();

      //result in JSON
      var responseJSON = await client.GetAsync("BFVUL.xml.json/api");       
