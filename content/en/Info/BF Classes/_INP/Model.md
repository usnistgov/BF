...
{{< img src="images/BF Models/_INP.png" height="300" caption="Figure 1. The BF Data Check Bugs model. Comprises phases, corresponding to the BF classes DVL and DVR. Shows the data check operations flow." >}}
