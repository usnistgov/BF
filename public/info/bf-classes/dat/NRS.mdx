...
{{< img src="images/BF Classes/DAT/NRS.svg" >}}
...
<tr>
	...
	<td>Incomplete Type error (or fault) – A specific constructor, method, or overridden function is missing.</td>
	</tr>
	<tr>
			<td>   Wrong Generic Type </td>
	<td>Wrong Generic Type error (or fault) – A generic object is instantiated via wrong type argument.</td>
	</tr>
	<tr>
	...
	<td>Wrong Type Resolved error (or fault) – A data type is resolved from a wrong scope.</td>
	</tr>
	<tr>
